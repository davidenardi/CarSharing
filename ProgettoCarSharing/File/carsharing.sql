...
--
-- Host: 127.0.0.1
-- Creato il: Gen 10, 2017 alle 11:26
...
(9, 'CD969RB', 'DMALDA18D91A000A', '2017-01-10', '2017-02-07', 0);
...
('NCLGO68B80E111T', 'NICOLA', 'GUGLIELMO', 'via dei cedri 190', '348463534'),
...
--
ALTER TABLE `noleggi`
  MODIFY `codice_noleggio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
